    ...
    <div class="modal-town">
        ...
        <div class="modal-town__box">
            ...
            <form class="modal-town__form" @submit.prevent="changeTown">
                <p class="modal-town__form--text">Введіть нову назву області в полі нижче</p>
                <input type="text" class="modal-town__form--input input" placeholder="Назва області" v-model="region"
                ...
                <p class="modal-town__form--text">Введіть нову назву района в полі нижче</p>
                <input type="text" class="modal-town__form--input input" placeholder="Назва района" v-model="area"
...
export default {
    name: "ModalEditTown",
    props: ['showModalEditTown', 'id', 'name', 'region', 'area'],
    validations: {
